    ...
    if(!pid) { // root
        ...
        for(var key in ds) {
            if(ds.hasOwnProperty(key)) {
                ...
                array.push({id: key, name: key, type: 'datasource', isParent: true, icon: '/public/images/db/database.png',children: [
...
var DB = {
    ...
    queryByPage: function(sql, start, length, callback) {
        dbObj.queryByPage(sql, start, length, callback);
    },
